...
DATASETS_OFFLINE = "/hdd/hans/TabLLM/datasets_serialized"
...
class CustomCategoricalReader(BaseDatasetReader):
    ...
    def get_template(self, template_idx):
        ...
        yaml_dict = yaml.load(open('/hdd/hans/TabLLM/templates/templates_' + task + '.yaml', "r"),
    ...
    def compute_metric(self, accumulated):
        ...
        store_probabilities = True  # Default False
        if store_probabilities:
            prop_output = 't0.p'
            with open(self.config.exp_dir + "/" + prop_output, 'wb') as f:
